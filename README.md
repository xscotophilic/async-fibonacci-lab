...
A web application that calculates Fibonacci numbers without freezing your browser.
...
3. **You get updates** -> The app shows progress and eventually displays your result
