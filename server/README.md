...
Server listens on http://localhost:5000. Note: this port is hardcoded as whole ecosystem is built around it, we tried making it env var but for few files in the ecosystem we were unable to read it.
...
- Port 5000 is hardcoded as whole ecosystem is built around it, we tried making it env var but for few files in the ecosystem we were unable to read it.
